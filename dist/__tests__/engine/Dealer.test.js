...
const Dealer_1 = require("../../engine/Dealer");
...
describe("Dealer", () => {
    ...
    beforeEach(() => {
        ...
        players = [
            new Player_1.Player("p1", "Player 1", 100, 0),
            new Player_1.Player("p2", "Player 2", 100, 1),
            new Player_1.Player("p3", "Player 3", 100, 2),
        ];
    ...
    test("should deal hole cards in round-robin fashion", () => {
        ...
        players[1].status = types_1.PlayerStatus.FOLDED;
...
//# sourceMappingURL=Dealer.test.js.map