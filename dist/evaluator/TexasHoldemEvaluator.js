...
exports.TexasHoldemEvaluator = void 0;
 ...
 */
class TexasHoldemEvaluator extends HandEvaluator_1.HandEvaluator {
    constructor(options = {}) {
        super(options);
    }
    /**
    ...
    evaluate(hand, communityCards) {
        ...
        const combinations = HandUtils_1.HandUtils.generateCombinations(allCards, Math.min(allCards.length, 5));
    ...
    evaluateLowHand(cards) {
        // Generate all possible 5-card combinations
        const combinations = HandUtils_1.HandUtils.generateCombinations(cards, Math.min(cards.length, 5));
...
exports.TexasHoldemEvaluator = TexasHoldemEvaluator;
//# sourceMappingURL=TexasHoldemEvaluator.js.map